...
namespace Metrics
{
    ...
    public static class Metric
    {
        ...
        /// <summary>
        ///     Entry point for Global Metrics Configuration.
        /// </summary>
        /// <example>
        ///     <code>
        /// Metric.Config
        ...
        /// <param name="unit">Description of what the is being measured ( Unit.Requests , Unit.Items etc ) .</param>
        /// <param name="tags">
        ///     Optional set of tags that can be associated with the metric. Tags can be string array or comma separated values in a string.
